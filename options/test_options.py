...
class TestOptions(BaseOptions):
	def initialize(self):
		...
		self.parser.add_argument('--output_dir_root', type=str, default='output/train_data')
		...
		self.parser.add_argument('--visualize_spectrogram', type=bool, default=False, help='whether to use discriminator')
		...
		self.parser.add_argument('--weights_visual', type=str, default='/data/whs/projects/co-separation/checkpoints/separation_withnewdataloader/audioVisual/visual_latest.pth', help="weights for visual stream")
		self.parser.add_argument('--weights_unet', type=str, default='/data/whs/projects/co-separation/checkpoints/separation_withnewdataloader/audioVisual/unet_latest.pth', help="weights for unet")
		self.parser.add_argument('--weights_classifier', type=str, default='/data/whs/projects/co-separation/checkpoints/separation_withnewdataloader/audioVisual/classifier_latest.pth', help="weights for audio classifier")
		...
		self.parser.add_argument('--with_additional_scene_image', type=bool, default=False, help="whether append an extra scene image")
		self.parser.add_argument('--num_of_object_detections_to_use', type=int, default=1, help="num of predictions to avg")


		self.parser.add_argument('--test_name', type=str, default='pretrain_co-separation', help='test name')
